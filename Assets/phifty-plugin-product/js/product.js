...
(function() {
  var Pager, productItemTemplate, productUsecaseItemTemplate,
  ...
  Product.ProductProductItemView = (function(_super) {
    ...
    function ProductProductItemView() {
      return ProductProductItemView.__super__.constructor.apply(this, arguments);
    }
  ...
  Product.ProductUseCaseItemView = (function(_super) {
    ...
    function ProductUseCaseItemView() {
      return ProductUseCaseItemView.__super__.constructor.apply(this, arguments);
    }
  ...
  window.ProductBulkCopyPlugin = (function() {
    ...
    ProductBulkCopyPlugin.prototype.register = function(bulk) {
      return bulk.addMenuItem('copy', '複製...', function(btn) {
        var $langsel, $productCateSel, cate, content, label, lang, option, runbtn, _i, _len, _ref;
        content = $('<div/>');
        $langsel = $('<select/>');
        ...
        _ref = window.Product.categories;
  ...
  Pager = (function() {
    ...
    Pager.prototype.updateUI = function() {
      ...
      if (this.page > 1) {
        $prevPage = $('<a/>').text('上一頁').appendTo(this.container).click((function(_this) {
          return function(e) {
            _this.prev();
      ...
      if (this.page < this.pages) {
        return $nextPage = $('<a/>').text('下一頁').appendTo(this.container).click((function(_this) {
          return function(e) {
            _this.next();
            if (_this.config.onPage) {
              _this.config.onPage(_this);
